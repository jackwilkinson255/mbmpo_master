...
class HalfCheetahPybulletEnvRandParams(BaseEnvRandParams, HalfCheetahEnv, Serializable):


    def __init__(self, *args, log_scale_limit=2.0, fix_params=True, rand_params=RAND_PARAMS, random_seed=None, max_path_length=None, **kwargs):
        """
        ...
        '''
        Example of inputs:
        args_all: [<__main__.HalfCheetahPybulletEnvRandParams object at 0x7f9d3b316438>]
        kwargs_all: {'log_scale_limit': 2.0, 'fix_params': False, 'rand_params': ['body_mass', 'dof_damping', 'body_inertia', 'geom_friction'], 'random_seed': None, 'max_path_length': None}
        '''
        print("args_all: ", args_all)
        print("kwargs_all: ", kwargs_all)
        ...
        self._obs_bounds() # Doesnt contain anything

        print("self.obs_bounds: ", self._obs_bounds())
...
if __name__ == "__main__":
    ...
    #Pybullet version
    env = HalfCheetahPybulletEnvRandParams()
    env.reset()
    print(env.model.body_mass)
